...
function App() {
  ...
  useEffect(() => {
    const newTime = {ID: 1, Name: 'I Klaipeda', Times: [{ID: 1, TimeHours: 6, TimeMinutes: 20}, {ID: 1, TimeHours: 7, TimeMinutes: '00'}]}
    const newTime2 = {ID: 2, Name: 'I Nida', Times: [{ID: 1, TimeHours: 6, TimeMinutes: 20}]}
    setCurrentIndex(1)
